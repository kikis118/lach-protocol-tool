...
Admin programma [lach.lv](https://lach.lv) WordPress vietnei: spēles
protokolu (PDF) augšupielāde, spēļu grafiku labošana, komandu sastāvi, logo
un citas ikdienas administrēšanas darbības, bez nepieciešamības ķerties pie
WP-Admin katru reizi. Protokola augšupielāde joprojām strādā kā līdz šim:
izvēlies PDF failu, tas tiek automātiski sasaistīts ar īsto spēli, tu
pārbaudi priekšskatījumu (rezultāts, spēlētāju statistika, vārti, sodi) un
tad saglabā. Var arī izveidot pilnīgi jaunu spēli, ja tāda WordPress vēl
nemaz nepastāv.

## Instalēšana

1. Iegūsti jaunāko instalatoru (`LACH Administrēšana Setup X.X.X.exe`) — vai nu no šī repozitorija [Releases lapas](https://github.com/kikis118/lach-protocol-tool/releases), vai kā citādi tas tev tika nosūtīts.
...
3. Atver "LACH Administrēšana" no Sākuma izvēlnes.
